...
# ADD LINK32 svncpp.lib libsvn_client-1.lib libsvn_delta-1.lib libsvn_diff-1.lib libsvn_fs_base-1.lib libsvn_fs-1.lib libsvn_fs_fs-1.lib libsvn_ra-1.lib libsvn_ra_dav-1.lib libsvn_ra_local-1.lib libsvn_ra_svn-1.lib libsvn_repos-1.lib libsvn_subr-1.lib libsvn_wc-1.lib libneond.lib libapriconv.lib xml.lib libapr.lib libaprutil.lib libdb43d.lib wxmsw26ud.lib wsock32.lib winspool.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib advapi32.lib kernel32.lib ole32.lib rpcrt4.lib shell32.lib comdlg32.lib gdi32.lib user32.lib comctl32.lib ws2_32.lib mswsock.lib shfolder.lib /nologo /subsystem:windows /debug /machine:I386 /pdbtype:sept /libpath:"src\svncpp\Debug" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_client" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_delta" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_diff" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_fs_base" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_fs" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_fs_fs" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_ra" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_ra_dav" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_ra_local" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_ra_svn" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_repos" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_subr" /libpath:"$(SUBVERSION)\Debug\subversion\libsvn_wc" /libpath:"$(SUBVERSION)\apr-iconv\Debug" /libpath:"$(SUBVERSION)\apr-util\xml\expat\lib\LibD" /libpath:"$(SUBVERSION)\apr\Debug" /libpath:"$(SUBVERSION)\apr-util\Debug" /libpath:"$(SUBVERSION)\neon" /libpath:"$(SUBVERSION)\db4-win32\lib" /libpath:"$(WX)\lib\vc_lib"
# SUBTRACT LINK32 /pdb:none
...
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 svncpp.lib libsvn_client-1.lib libsvn_delta-1.lib libsvn_diff-1.lib libsvn_fs_base-1.lib libsvn_fs-1.lib libsvn_fs_fs-1.lib libsvn_ra-1.lib libsvn_ra_dav-1.lib libsvn_ra_local-1.lib libsvn_ra_svn-1.lib libsvn_repos-1.lib libsvn_subr-1.lib libsvn_wc-1.lib libneon.lib libapriconv.lib xml.lib libapr.lib libaprutil.lib libdb43.lib wxmsw26u.lib wsock32.lib winspool.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib advapi32.lib kernel32.lib ole32.lib rpcrt4.lib shell32.lib comdlg32.lib gdi32.lib user32.lib comctl32.lib ws2_32.lib mswsock.lib shfolder.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"libcmt" /libpath:"src\svncpp\Release" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_client" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_delta" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_diff" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_fs_base" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_fs" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_fs_fs" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_ra" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_ra_dav" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_ra_local" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_ra_svn" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_repos" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_subr" /libpath:"$(SUBVERSION)\Release\subversion\libsvn_wc" /libpath:"$(SUBVERSION)\apr-iconv\Release" /libpath:"$(SUBVERSION)\apr-util\xml\expat\lib\LibR" /libpath:"$(SUBVERSION)\apr\Release" /libpath:"$(SUBVERSION)\apr-util\Release" /libpath:"$(SUBVERSION)\neon" /libpath:"$(SUBVERSION)\db4-win32\lib" /libpath:"$(WX)\lib\vc_lib"
# SUBTRACT LINK32 /pdb:none
