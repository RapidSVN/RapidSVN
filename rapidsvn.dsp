...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "$(WX)/include" /I "$(WX)/contrib/include" /I "$(SUBVERSION)/apr/include" /I "$(SUBVERSION)/apr-util/include" /I "$(SUBVERSION)/apr-util/xml/expat/lib" /I "$(SUBVERSION)/subversion/include" /D "__WXMSW__" /D "NDEBUG" /D "_MBCS" /D "WIN32" /D "_WINDOWS" /D "APR_DECLARE_STATIC" /D "__WIN95__" /D "__WIN32__" /D "STRICT" /YX /FD /c
...
# ADD LINK32 src\svncpp\Debug\svncpp.lib $(SUBVERSION)\Debug\libsvn_diff.lib $(SUBVERSION)\Debug\libsvn_repos.lib $(SUBVERSION)\Debug\libsvn_fs.lib $(SUBVERSION)\Debug\libsvn_ra_dav.lib $(SUBVERSION)\Debug\libsvn_ra_local.lib $(SUBVERSION)\Debug\libsvn_ra_svn.lib $(SUBVERSION)\Debug\libsvn_ra.lib $(SUBVERSION)\neon\libneond.lib $(SUBVERSION)\apr-iconv\LibD\apriconv.lib $(SUBVERSION)\Debug\libsvn_wc.lib $(SUBVERSION)\Debug\libsvn_subr.lib $(SUBVERSION)\apr-util\xml\expat\lib\LibD\xml.lib $(SUBVERSION)\Debug\libsvn_client.lib $(SUBVERSION)\Debug\libsvn_delta.lib $(SUBVERSION)\apr\LibD\apr.lib $(SUBVERSION)\apr-util\LibD\aprutil.lib $(SUBVERSION)\db4-win32\lib\libdb40d.lib "$(WX)\lib\wxmswd.lib" wsock32.lib winspool.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib advapi32.lib kernel32.lib ole32.lib rpcrt4.lib shell32.lib comdlg32.lib gdi32.lib user32.lib comctl32.lib ws2_32.lib mswsock.lib shfolder.lib /nologo /subsystem:windows /debug /machine:I386 /pdbtype:sept /libpath:"../../lib" /libpath:"../../contrib/lib"
# SUBTRACT LINK32 /pdb:none
