...
[Setup]
AppName=RapidSVN-0.9.8
AppVerName=RapidSVN-0.9.8
AppPublisherURL=http://rapidsvn.tigris.org/
AppSupportURL=http://rapidsvn.tigris.org/
AppUpdatesURL=http://rapidsvn.tigris.org/
DefaultDirName={pf}\RapidSVN-0.9.8
DefaultGroupName=RapidSVN-0.9.8
LicenseFile=..\..\GPL.txt
InfoBeforeFile=..\..\README
OutputBaseFilename=RapidSVN-0.9.8
...
Name: "{userdesktop}\RapidSVN-0.9.8"; Filename: "{app}\bin\rapidsvn.exe"; WorkingDir: "{app}\bin"; Tasks: desktopicon
