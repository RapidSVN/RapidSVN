...
void CheckoutDlg::OnOk( wxCommandEvent& WXUNUSED(event) )
{
	wxString		val;
	unsigned long	rev = 0; 
...
void CheckoutDlg::OnCancel( wxCommandEvent& WXUNUSED(event) )
{
	EndModal( ID_BUTTON_CANCEL );
}

void CheckoutDlg::OnBrowse( wxCommandEvent& event )
{
...
void CheckoutDlg::InitializeData()
{
