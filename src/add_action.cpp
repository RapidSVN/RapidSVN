...
AddAction::AddAction( wxFrame* frame, apr_pool_t *__pool, 
...
void* AddAction::Entry()
{
	...
	for( i = 0; i < targets->nelts; i++ )
	{
		...
		err =  svn_client_add( target,
								1,				// recursive (should get it from conf)
								notify_func,
								notify_baton,
								subpool );
