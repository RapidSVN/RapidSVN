...
ImportAction::ImportAction( wxFrame* frame, apr_pool_t *__pool, Tracer* tr )
:	ActionThread( frame, __pool )
{
	SetTracer( tr, FALSE );		// do not own the tracer
}

void ImportAction::Perform()
{
...
void* ImportAction::Entry()
{
	...
	svn_error_t	*err = svn_client_import( &commit_info,
										...
										svn_cl__make_log_msg_baton( logMsg.c_str(), NULL, pool ),
										NULL,
										revnum,
