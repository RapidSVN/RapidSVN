...
EVT_BUTTON (ID_BUTTON_CANCEL, DeleteDlg::OnCancel) END_EVENT_TABLE ()
     void
     DeleteDlg::OnOk (wxCommandEvent & WXUNUSED (event))
{
  EndModal (ID_BUTTON_OK);
}

void
DeleteDlg::OnCancel (wxCommandEvent & WXUNUSED (event))
{
